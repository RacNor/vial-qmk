...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL,   KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_LBRC,      KC_RBRC, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                                     KC_LGUI, TG(3),   KC_LALT, KC_SPC,                KC_ENT,  KC_BSPC, TG(2),   KC_GRV
    ),
    [1] = LAYOUT(
        KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MPLY,        KC_MPLY, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
    ...
    [4] = LAYOUT(
        XXXXXXX, TO(0),   TO(1),   XXXXXXX, XXXXXXX, QK_BOOT, _______,        _______, XXXXXXX, XXXXXXX, XXXXXXX, RGB_MOD, RGB_SAI, RGB_TOG,
